...
$info = [
	...
	'requires_php' => '',
	'tested' => '',
	'added' => date('r', filectime($pluginfile)),
	'last_updated' => date('r', fileatime($pluginfile)),
	'sections' => [
		'description' => '',
		'installation' => '',
		'changelog' => ''
...
$info['sections']['changelog'] = $converter->convert($changelog)->getContent();
$info['sections']['description'] = $converter->convert($description)->getContent();
